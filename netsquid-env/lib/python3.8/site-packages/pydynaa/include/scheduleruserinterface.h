...
// Value from which scheduleAfter should issue a warning.
const SimTime _rounding_errors_warning_limit = 1e13;
...
public:
     ...
     * 
     * Should issue a warning (cerr) if the difference between the actual simulation time
     * and the given interval is larger than _rounding_errors_warning_limit
     * 
     */
