...
<head>
  ...
  <title>netsquid.examples.teleportation &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.examples.entanglenodes" href="netsquid.examples.entanglenodes.html" />
    <link rel="prev" title="netsquid.examples" href="../netsquid.examples.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.examples.teleportation</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.examples.teleportation</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_examples/netsquid.examples.teleportation.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="../netsquid.examples.html" class="btn btn-neutral float-left" title="netsquid.examples" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.examples.entanglenodes.html" class="btn btn-neutral float-right" title="netsquid.examples.entanglenodes" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.examples.teleportation">
<span id="netsquid-examples-teleportation"></span><h1>netsquid.examples.teleportation<a class="headerlink" href="#module-netsquid.examples.teleportation" title="Permalink to this heading"></a></h1>
<p>This example demonstrates quantum teleportation between two remote nodes
linked by an entangling connection and a classical connection.</p>
<p class="rubric">Example</p>
<p>The following script runs an example simulation.
Open the module file to understand how the network and simulation are setup,
and how the protocol works.</p>
...
<span class="gp">... </span>      <span class="n">ns</span><span class="o">.</span><span class="n">examples</span><span class="o">.</span><span class="n">teleportation</span><span class="o">.</span><span class="vm">__file__</span><span class="p">))</span>
<span class="go">This example module is located at: .../netsquid/examples/teleportation.py</span>
<span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">netsquid.examples.teleportation</span> <span class="kn">import</span> <span class="p">(</span>
<span class="gp">... </span>    <span class="n">example_network_setup</span><span class="p">,</span> <span class="n">example_sim_setup</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">network</span> <span class="o">=</span> <span class="n">example_network_setup</span><span class="p">(</span><span class="n">node_distance</span><span class="o">=</span><span class="mf">4e-3</span><span class="p">,</span> <span class="n">depolar_rate</span><span class="o">=</span><span class="mi">0</span><span class="p">,</span> <span class="n">dephase_rate</span><span class="o">=</span><span class="mi">0</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">node_a</span> <span class="o">=</span> <span class="n">network</span><span class="o">.</span><span class="n">get_node</span><span class="p">(</span><span class="s2">&quot;Alice&quot;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">node_b</span> <span class="o">=</span> <span class="n">network</span><span class="o">.</span><span class="n">get_node</span><span class="p">(</span><span class="s2">&quot;Bob&quot;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">protocol_alice</span><span class="p">,</span> <span class="n">protocol_bob</span><span class="p">,</span> <span class="n">dc</span> <span class="o">=</span> <span class="n">example_sim_setup</span><span class="p">(</span><span class="n">node_a</span><span class="p">,</span> <span class="n">node_b</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">protocol_alice</span><span class="o">.</span><span class="n">start</span><span class="p">()</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">protocol_bob</span><span class="o">.</span><span class="n">start</span><span class="p">()</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">q_conn</span> <span class="o">=</span> <span class="n">network</span><span class="o">.</span><span class="n">get_connection</span><span class="p">(</span><span class="n">node_a</span><span class="p">,</span> <span class="n">node_b</span><span class="p">,</span> <span class="n">label</span><span class="o">=</span><span class="s2">&quot;quantum&quot;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">cycle_runtime</span> <span class="o">=</span> <span class="p">(</span><span class="n">q_conn</span><span class="o">.</span><span class="n">subcomponents</span><span class="p">[</span><span class="s2">&quot;qsource&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">subcomponents</span><span class="p">[</span><span class="s2">&quot;internal_clock&quot;</span><span class="p">]</span>
<span class="gp">... </span>                 <span class="o">.</span><span class="n">models</span><span class="p">[</span><span class="s2">&quot;timing_model&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">delay</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">ns</span><span class="o">.</span><span class="n">sim_run</span><span class="p">(</span><span class="n">cycle_runtime</span> <span class="o">*</span> <span class="mi">100</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Mean fidelity of teleported state: </span><span class="si">{</span><span class="n">dc</span><span class="o">.</span><span class="n">dataframe</span><span class="p">[</span><span class="s1">&#39;fidelity&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">mean</span><span class="p">()</span><span class="si">:</span><span class="s2">.3f</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">)</span>
<span class="go">Mean fidelity of teleported state: 1.000</span>
</pre></div>
</div>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.examples.teleportation.</span></span><span class="sig-name descname"><span class="pre">EntanglingConnection</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">length</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">source_frequency</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">'EntanglingConnection'</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection" title="Permalink to this definition"></a></dt>
...
<p>A connection that generates entanglement.</p>
<p>Consists of a midpoint holding a quantum source that connects to
outgoing quantum channels.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>length</strong> (<em>float</em>) – End to end length of the connection [km].</p></li>
<li><p><strong>source_frequency</strong> (<em>float</em>) – Frequency with which midpoint entanglement source generates entanglement [Hz].</p></li>
<li><p><strong>name</strong> (<em>str, optional</em>) – Name of this connection.</p></li>
</ul>
</dd>
</dl>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.add_ports">
<span class="sig-name descname"><span class="pre">add_ports</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">names</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.add_ports" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.add_property">
<span class="sig-name descname"><span class="pre">add_property</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">mutable</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_constraints</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.add_property" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.has_subcomponent">
<span class="sig-name descname"><span class="pre">has_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.has_subcomponent" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.has_supercomponent">
<span class="sig-name descname"><span class="pre">has_supercomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.has_supercomponent" title="Permalink to this definition"></a></dt>
<dd><p>Whether argument is a supercomponent of this component at any level.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.models">
<span class="sig-name descname"><span class="pre">models</span></span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.models" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.name" title="Permalink to this definition"></a></dt>
...
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.port_A">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">port_A</span></span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.port_A" title="Permalink to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.port_B">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">port_B</span></span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.port_B" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.ports">
<span class="sig-name descname"><span class="pre">ports</span></span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.ports" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.properties">
<span class="sig-name descname"><span class="pre">properties</span></span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.properties" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.rem_subcomponent">
<span class="sig-name descname"><span class="pre">rem_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.rem_subcomponent" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.remove">
<span class="sig-name descname"><span class="pre">remove</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.remove" title="Permalink to this definition"></a></dt>
<dd><p>Removes the entity from the simulation.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.reset" title="Permalink to this definition"></a></dt>
<dd><p>Reset the component.</p>
<p>Will reset all of its ports and (sub)components.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.specify_model">
<span class="sig-name descname"><span class="pre">specify_model</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">model_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.specify_model" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.subcomponents">
<span class="sig-name descname"><span class="pre">subcomponents</span></span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.subcomponents" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.supercomponent">
<span class="sig-name descname"><span class="pre">supercomponent</span></span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.supercomponent" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.EntanglingConnection.uid">
<span class="sig-name descname"><span class="pre">uid</span></span><a class="headerlink" href="#netsquid.examples.teleportation.EntanglingConnection.uid" title="Permalink to this definition"></a></dt>
...
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.examples.teleportation.</span></span><span class="sig-name descname"><span class="pre">ClassicalConnection</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">length</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">'ClassicalConnection'</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection" title="Permalink to this definition"></a></dt>
<dd><p>Bases: <a class="reference internal" href="../api_nodes/netsquid.nodes.connections.html#netsquid.nodes.connections.Connection" title="netsquid.nodes.connections.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a></p>
<p>A connection that transmits classical messages in one direction, from A to B.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>length</strong> (<em>float</em>) – End to end length of the connection [km].</p></li>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.add_ports">
<span class="sig-name descname"><span class="pre">add_ports</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">names</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.add_ports" title="Permalink to this definition"></a></dt>
<dd><p>Add ports to this component.</p>
<p>Added ports are accessible via <a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Component.ports" title="netsquid.components.component.Component.ports"><code class="xref py py-attr docutils literal notranslate"><span class="pre">ports</span></code></a>.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.add_property">
<span class="sig-name descname"><span class="pre">add_property</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">mutable</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_constraints</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.add_property" title="Permalink to this definition"></a></dt>
<dd><p>Add a property to this component.</p>
<p>Properties can be accessed and modified via the
<a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Component.properties" title="netsquid.components.component.Component.properties"><code class="xref py py-attr docutils literal notranslate"><span class="pre">properties</span></code></a> attribute.</p>
<p>If a property with this name already exists, an attempt will be made to
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.add_subcomponent">
<span class="sig-name descname"><span class="pre">add_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">forward_input</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">forward_output</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">add_ports</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.add_subcomponent" title="Permalink to this definition"></a></dt>
<dd><p>Add a subcomponent to this component.</p>
<p>Subcomponents can be accessed using the
<a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Component.subcomponents" title="netsquid.components.component.Component.subcomponents"><code class="xref py py-attr docutils literal notranslate"><span class="pre">subcomponents</span></code></a> property.</p>
<p>If a component already exists with this name identifier it will be replaced.</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.has_subcomponent">
<span class="sig-name descname"><span class="pre">has_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.has_subcomponent" title="Permalink to this definition"></a></dt>
<dd><p>Whether argument is a subcomponent of this component at any level.</p>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
<dd class="field-odd"><p>True if component contained as a subcomponent at any level, otherwise False.</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.has_supercomponent">
<span class="sig-name descname"><span class="pre">has_supercomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.has_supercomponent" title="Permalink to this definition"></a></dt>
<dd><p>Whether argument is a supercomponent of this component at any level.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.models">
<span class="sig-name descname"><span class="pre">models</span></span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.models" title="Permalink to this definition"></a></dt>
<dd><p>the models associated with this component.</p>
<p>Models that a component can hold are strictly define at construction.
To change the model use:
<code class="xref py py-meth docutils literal notranslate"><span class="pre">models[name_model]</span> <span class="pre">=</span> <span class="pre">model()</span></code>.</p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.name" title="Permalink to this definition"></a></dt>
<dd><p>Name of component for identification and display purposes.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p>str</p>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.port_A">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">port_A</span></span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.port_A" title="Permalink to this definition"></a></dt>
<dd><p>port for IO at remote location A.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Port" title="netsquid.components.component.Port"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Port</span></code></a></p>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.port_B">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">port_B</span></span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.port_B" title="Permalink to this definition"></a></dt>
<dd><p>port for IO at remote location B.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Port" title="netsquid.components.component.Port"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Port</span></code></a></p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.ports">
<span class="sig-name descname"><span class="pre">ports</span></span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.ports" title="Permalink to this definition"></a></dt>
<dd><p>ports belonging to this component.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.ConstrainedMap" title="netsquid.util.constrainedmap.ConstrainedMap"><code class="xref py py-obj docutils literal notranslate"><span class="pre">ConstrainedMap</span></code></a></p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.properties">
<span class="sig-name descname"><span class="pre">properties</span></span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.properties" title="Permalink to this definition"></a></dt>
<dd><p>the properties associated with this component.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.ConstrainedMap" title="netsquid.util.constrainedmap.ConstrainedMap"><code class="xref py py-obj docutils literal notranslate"><span class="pre">ConstrainedMap</span></code></a></p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.rem_subcomponent">
<span class="sig-name descname"><span class="pre">rem_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.rem_subcomponent" title="Permalink to this definition"></a></dt>
<dd><p>Remove a subcomponent from this component.</p>
<p>Outgoing port connections are disconnected to keep the hierarchy consistent;
That means that any port connections to the parent or siblings are disconnected.
Input ports to subcomponents remain.</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.remove">
<span class="sig-name descname"><span class="pre">remove</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.remove" title="Permalink to this definition"></a></dt>
<dd><p>Removes the entity from the simulation.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.reset" title="Permalink to this definition"></a></dt>
<dd><p>Reset the component.</p>
<p>Will reset all of its ports and (sub)components.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.specify_model">
<span class="sig-name descname"><span class="pre">specify_model</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">model_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.specify_model" title="Permalink to this definition"></a></dt>
<dd><p>Specify the model types needed by this component.</p>
<p>Models that are not first specified cannot be set. To set a model do
<cite>Component.models[name_model] = model</cite>.</p>
<dl class="field-list simple">
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.subcomponents">
<span class="sig-name descname"><span class="pre">subcomponents</span></span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.subcomponents" title="Permalink to this definition"></a></dt>
<dd><p>Return list of subcomponents of this component and their identifiers.</p>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
<dd class="field-odd"><p>Subcomponents of this component.</p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.supercomponent">
<span class="sig-name descname"><span class="pre">supercomponent</span></span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.supercomponent" title="Permalink to this definition"></a></dt>
<dd><p>parent component, if any.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Component" title="netsquid.components.component.Component"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Component</span></code></a> or None</p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.ClassicalConnection.uid">
<span class="sig-name descname"><span class="pre">uid</span></span><a class="headerlink" href="#netsquid.examples.teleportation.ClassicalConnection.uid" title="Permalink to this definition"></a></dt>
<dd><p>returns a unique identifier for this entity in the simulation.</p>
<p>Each entity has a unique identifier in the simulation.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.InitStateProgram">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.examples.teleportation.</span></span><span class="sig-name descname"><span class="pre">InitStateProgram</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">num_qubits</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">parallel</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">qubit_mapping</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.InitStateProgram" title="Permalink to this definition"></a></dt>
...
<p>Program to create a qubit and transform it to the y0 state.</p>
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.InitStateProgram.default_num_qubits">
<span class="sig-name descname"><span class="pre">default_num_qubits</span></span><em class="property"><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">1</span></em><a class="headerlink" href="#netsquid.examples.teleportation.InitStateProgram.default_num_qubits" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.InitStateProgram.program">
<span class="sig-name descname"><span class="pre">program</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.InitStateProgram.program" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.InitStateProgram.get_qubit_indices">
<span class="sig-name descname"><span class="pre">get_qubit_indices</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">num_qubits</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.InitStateProgram.get_qubit_indices" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.InitStateProgram.load">
<span class="sig-name descname"><span class="pre">load</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">program</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.InitStateProgram.load" title="Permalink to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.InitStateProgram.num_qubits">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">num_qubits</span></span><a class="headerlink" href="#netsquid.examples.teleportation.InitStateProgram.num_qubits" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.InitStateProgram.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.InitStateProgram.reset" title="Permalink to this definition"></a></dt>
<dd><p>Reset state of program.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.InitStateProgram.run">
<span class="sig-name descname"><span class="pre">run</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">parallel</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">lazy</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.InitStateProgram.run" title="Permalink to this definition"></a></dt>
...
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProgram">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.examples.teleportation.</span></span><span class="sig-name descname"><span class="pre">BellMeasurementProgram</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">num_qubits</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">parallel</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">qubit_mapping</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProgram" title="Permalink to this definition"></a></dt>
<dd><p>Bases: <a class="reference internal" href="../api_components/netsquid.components.qprogram.html#netsquid.components.qprogram.QuantumProgram" title="netsquid.components.qprogram.QuantumProgram"><code class="xref py py-class docutils literal notranslate"><span class="pre">QuantumProgram</span></code></a></p>
<p>Program to perform a Bell measurement on two qubits.</p>
<p>Measurement results are stored in output keys “M1” and “M2”</p>
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProgram.default_num_qubits">
<span class="sig-name descname"><span class="pre">default_num_qubits</span></span><em class="property"><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">2</span></em><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProgram.default_num_qubits" title="Permalink to this definition"></a></dt>
<dd><p>default number of qubits program requires. If -1 it can run on any number of qubits.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p>int</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProgram.program">
<span class="sig-name descname"><span class="pre">program</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProgram.program" title="Permalink to this definition"></a></dt>
<dd><p>Program to be executed.</p>
<p>Override this method to add additional control logic.</p>
<p>By default runs a single sequences of instructions that
have been added using <code class="docutils literal notranslate"><span class="pre">apply()</span></code>.</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProgram.apply">
<span class="sig-name descname"><span class="pre">apply</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">instruction</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">qubit_indices</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">output_key</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">'last'</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">physical</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">parameters</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProgram.apply" title="Permalink to this definition"></a></dt>
<dd><p>Prepare to apply an instruction.</p>
<p>Prepares a callback function that will be called when the instruction
is executed by a quantum processor.</p>
<dl class="field-list simple">
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProgram.get_qubit_indices">
<span class="sig-name descname"><span class="pre">get_qubit_indices</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">num_qubits</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProgram.get_qubit_indices" title="Permalink to this definition"></a></dt>
<dd><p>Convenience method that returns the program’s qubit indices.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>num_qubits</strong> (<em>int or None, optional</em>) – Number of qubit indices to return. If <code class="docutils literal notranslate"><span class="pre">None</span></code>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProgram.load">
<span class="sig-name descname"><span class="pre">load</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">program</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProgram.load" title="Permalink to this definition"></a></dt>
<dd><p>Load in and run another quantum program within this program.</p>
<p>To be called within an overridden <code class="docutils literal notranslate"><span class="pre">program()</span></code> method.
Should be prepepended by <code class="docutils literal notranslate"><span class="pre">yield</span> <span class="pre">from</span></code> (see example below).</p>
<p>The <code class="docutils literal notranslate"><span class="pre">output</span></code> dict is shared between both programs.</p>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProgram.num_qubits">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">num_qubits</span></span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProgram.num_qubits" title="Permalink to this definition"></a></dt>
<dd><p>number of qubits program requires. If -1 can run on any number of qubits.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p>int</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProgram.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProgram.reset" title="Permalink to this definition"></a></dt>
<dd><p>Reset state of program.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProgram.run">
<span class="sig-name descname"><span class="pre">run</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">parallel</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">lazy</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProgram.run" title="Permalink to this definition"></a></dt>
<dd><p>Carry out all applied instructions within the program to this point.</p>
<p>Called within an overridden <code class="docutils literal notranslate"><span class="pre">program()</span></code> method.
Should be prepepended by <code class="docutils literal notranslate"><span class="pre">yield</span></code> (see example below).</p>
<dl class="field-list simple">
...
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.examples.teleportation.</span></span><span class="sig-name descname"><span class="pre">BellMeasurementProtocol</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">node</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol" title="Permalink to this definition"></a></dt>
...
<p>Protocol to perform a Bell measurement when qubits are available.</p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.run">
<span class="sig-name descname"><span class="pre">run</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.run" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.add_signal">
<span class="sig-name descname"><span class="pre">add_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">event_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.add_signal" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.add_subprotocol">
<span class="sig-name descname"><span class="pre">add_subprotocol</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">subprotocol</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.add_subprotocol" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.await_mempos_busy_toggle">
<span class="sig-name descname"><span class="pre">await_mempos_busy_toggle</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">QuantumMemory</span> <span class="pre">qmemory</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">list</span> <span class="pre">positions</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.await_mempos_busy_toggle" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.await_mempos_in_use_toggle">
<span class="sig-name descname"><span class="pre">await_mempos_in_use_toggle</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">QuantumMemory</span> <span class="pre">qmemory</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">list</span> <span class="pre">positions</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.await_mempos_in_use_toggle" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.await_port_input">
<span class="sig-name descname"><span class="pre">await_port_input</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">port</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.await_port_input" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.await_port_output">
<span class="sig-name descname"><span class="pre">await_port_output</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">port</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.await_port_output" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.await_program">
<span class="sig-name descname"><span class="pre">await_program</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">processor</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">await_done=True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">await_fail=False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.await_program" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.await_signal">
<span class="sig-name descname"><span class="pre">await_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">Protocol</span> <span class="pre">sender</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">signal_label=Signals.FINISHED</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.await_signal" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.await_timer">
<span class="sig-name descname"><span class="pre">await_timer</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">duration=0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">end_time=0</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.await_timer" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.can_signal_to">
<span class="sig-name descname"><span class="pre">can_signal_to</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">protocol</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.can_signal_to" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.check_assigned">
<em class="property"><span class="pre">static</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">check_assigned</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">inputs</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">input_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.check_assigned" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.get_signal_by_event">
<span class="sig-name descname"><span class="pre">get_signal_by_event</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">event</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">receiver</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.get_signal_by_event" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.get_signal_result">
<span class="sig-name descname"><span class="pre">get_signal_result</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">receiver</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.get_signal_result" title="Permalink to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.is_connected">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">is_connected</span></span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.is_connected" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.is_running">
<span class="sig-name descname"><span class="pre">is_running</span></span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.is_running" title="Permalink to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.max_nodes">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">max_nodes</span></span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.max_nodes" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.name" title="Permalink to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.node">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">node</span></span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.node" title="Permalink to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.nodes">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">nodes</span></span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.nodes" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.remove">
<span class="sig-name descname"><span class="pre">remove</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.remove" title="Permalink to this definition"></a></dt>
<dd><p>Removes the entity from the simulation.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.reset" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.send_signal">
<span class="sig-name descname"><span class="pre">send_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">signal_label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">result</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.send_signal" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.signals">
<span class="sig-name descname"><span class="pre">signals</span></span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.signals" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.specify_node">
<span class="sig-name descname"><span class="pre">specify_node</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.specify_node" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.start">
<span class="sig-name descname"><span class="pre">start</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.start" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.start_subprotocols">
<span class="sig-name descname"><span class="pre">start_subprotocols</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.start_subprotocols" title="Permalink to this definition"></a></dt>
<dd><p>Start all the sub-protocols in parallel.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.stop">
<span class="sig-name descname"><span class="pre">stop</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.stop" title="Permalink to this definition"></a></dt>
<dd><p>Stop the protocol as well as any running sub-protocols.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.subprotocols">
<span class="sig-name descname"><span class="pre">subprotocols</span></span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.subprotocols" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.BellMeasurementProtocol.uid">
<span class="sig-name descname"><span class="pre">uid</span></span><a class="headerlink" href="#netsquid.examples.teleportation.BellMeasurementProtocol.uid" title="Permalink to this definition"></a></dt>
<dd><p>returns a unique identifier for this entity in the simulation.</p>
<p>Each entity has a unique identifier in the simulation.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.examples.teleportation.</span></span><span class="sig-name descname"><span class="pre">CorrectionProtocol</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">node</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol" title="Permalink to this definition"></a></dt>
<dd><p>Bases: <a class="reference internal" href="../api_protocols/netsquid.protocols.nodeprotocols.html#netsquid.protocols.nodeprotocols.NodeProtocol" title="netsquid.protocols.nodeprotocols.NodeProtocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">NodeProtocol</span></code></a></p>
<p>Protocol to perform corrections on Bobs qubit when available and measurements received</p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.run">
<span class="sig-name descname"><span class="pre">run</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.run" title="Permalink to this definition"></a></dt>
<dd><p>Generator or function that runs the protocol.</p>
<p>Starting the protocol will execute this function.
If a generator it will run it up to the first yield.
All yields should return a <a class="reference internal" href="../pydynaa.html#pydynaa.core.EventExpression" title="pydynaa.core.EventExpression"><code class="xref py py-class docutils literal notranslate"><span class="pre">EventExpression</span></code></a>,
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.add_signal">
<span class="sig-name descname"><span class="pre">add_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">event_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.add_signal" title="Permalink to this definition"></a></dt>
<dd><p>Adds a signal type to the protocol that it can signal.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.add_subprotocol">
<span class="sig-name descname"><span class="pre">add_subprotocol</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">subprotocol</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.add_subprotocol" title="Permalink to this definition"></a></dt>
<dd><p>Add a sub-protocol to this protocol.</p>
<p>Neither protocol should be running and both protocols must be able to
signal to each other (see <a class="reference internal" href="../api_protocols/netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol.can_signal_to" title="netsquid.protocols.protocol.Protocol.can_signal_to"><code class="xref py py-meth docutils literal notranslate"><span class="pre">can_signal_to()</span></code></a>).</p>
<dl class="field-list simple">
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.await_mempos_busy_toggle">
<span class="sig-name descname"><span class="pre">await_mempos_busy_toggle</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">QuantumMemory</span> <span class="pre">qmemory</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">list</span> <span class="pre">positions</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.await_mempos_busy_toggle" title="Permalink to this definition"></a></dt>
<dd><p>Create an event expression that waits for one of the memory positions
on a quantum memory to change the value of the busy state.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.await_mempos_in_use_toggle">
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.await_port_input">
<span class="sig-name descname"><span class="pre">await_port_input</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">port</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.await_port_input" title="Permalink to this definition"></a></dt>
<dd><p>Create an event expression that waits until the specified port receives a message input.</p>
<p>The event expression will also trigger if the message is passed through the port.
The expression must be <em>yielded</em> on to come into effect (see example below).</p>
<dl class="field-list simple">
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.await_port_output">
<span class="sig-name descname"><span class="pre">await_port_output</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">port</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.await_port_output" title="Permalink to this definition"></a></dt>
<dd><p>Create an event expression that waits until the specified port has a message output.</p>
<p>The event expression will also trigger if the message is passed through the port.
The expression must be <em>yielded</em> on to come into effect (see example below).</p>
<dl class="field-list simple">
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.await_program">
<span class="sig-name descname"><span class="pre">await_program</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">processor</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">await_done=True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">await_fail=False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.await_program" title="Permalink to this definition"></a></dt>
<dd><p>Create an event expression that waits for a program on a quantum processor to stop running.</p>
<p>The expression must be <em>yielded</em> on to come into effect.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.await_signal">
<span class="sig-name descname"><span class="pre">await_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">Protocol</span> <span class="pre">sender</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">signal_label=Signals.FINISHED</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.await_signal" title="Permalink to this definition"></a></dt>
<dd><p>Create an event expression that waits until a sender has sent a specified signal.</p>
<p>The expression must be <em>yielded</em> on to come into effect (see example below).</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.await_timer">
<span class="sig-name descname"><span class="pre">await_timer</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">duration=0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">end_time=0</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.await_timer" title="Permalink to this definition"></a></dt>
<dd><p>Schedule an event to trigger at a specified time and create an event expression to wait for it.</p>
<p>The expression must be <em>yielded</em> on to come into effect.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.can_signal_to">
<span class="sig-name descname"><span class="pre">can_signal_to</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">protocol</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.can_signal_to" title="Permalink to this definition"></a></dt>
<dd><p>Whether this protocol can send a signal to another protocol.</p>
<p>A local protocol can only signal to another local protocol if they have
one or more nodes in common.
A local protocol can always signal to a standard (non-local) protocol.</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.check_assigned">
<em class="property"><span class="pre">static</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">check_assigned</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">inputs</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">input_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.check_assigned" title="Permalink to this definition"></a></dt>
<dd><p>Helper method to check if inputs properly assigned.</p>
<p>Checks that inputs are not None and that they have correct type.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.get_signal_by_event">
<span class="sig-name descname"><span class="pre">get_signal_by_event</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">event</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">receiver</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.get_signal_by_event" title="Permalink to this definition"></a></dt>
<dd><p>Get the signal result based on the event that triggered it.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.get_signal_result">
<span class="sig-name descname"><span class="pre">get_signal_result</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">receiver</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.get_signal_result" title="Permalink to this definition"></a></dt>
<dd><p>Get the result of the last signal sent with this label.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.is_connected">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">is_connected</span></span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.is_connected" title="Permalink to this definition"></a></dt>
<dd><p>Whether protocol has been properly configured and can be started.</p>
<p>Requires that all specified nodes have been set (are not None).</p>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.is_running">
<span class="sig-name descname"><span class="pre">is_running</span></span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.is_running" title="Permalink to this definition"></a></dt>
<dd><p><code class="xref py py-obj docutils literal notranslate"><span class="pre">bool</span></code> True if protocol is running, otherwise False.</p>
</dd></dl>

<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.max_nodes">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">max_nodes</span></span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.max_nodes" title="Permalink to this definition"></a></dt>
<dd><p>maximum number of nodes this local protocol can run on.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p>int</p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.name" title="Permalink to this definition"></a></dt>
<dd><p>Name of protocol for identification and display purposes.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p>str</p>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.node">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">node</span></span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.node" title="Permalink to this definition"></a></dt>
<dd><p>single node this protocol is running on.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_nodes/netsquid.nodes.node.html#netsquid.nodes.node.Node" title="netsquid.nodes.node.Node"><code class="xref py py-class docutils literal notranslate"><span class="pre">Node</span></code></a></p>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.nodes">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">nodes</span></span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.nodes" title="Permalink to this definition"></a></dt>
<dd><p>nodes local to this protocol.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.ConstrainedMap" title="netsquid.util.constrainedmap.ConstrainedMap"><code class="xref py py-obj docutils literal notranslate"><span class="pre">ConstrainedMap</span></code></a></p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.remove">
<span class="sig-name descname"><span class="pre">remove</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.remove" title="Permalink to this definition"></a></dt>
<dd><p>Removes the entity from the simulation.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.reset" title="Permalink to this definition"></a></dt>
<dd><p>Stops and starts the protocol leaving it in a clean state.</p>
<p>Will stop the protocol with the specified status,
or Status.FAIL if not specified. Leaves the protocol in the Protocol.IDLE state.</p>
</dd></dl>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.send_signal">
<span class="sig-name descname"><span class="pre">send_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">signal_label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">result</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.send_signal" title="Permalink to this definition"></a></dt>
<dd><p>Send a signal to other protocols to indicate a status change or announce a result.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.signals">
<span class="sig-name descname"><span class="pre">signals</span></span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.signals" title="Permalink to this definition"></a></dt>
<dd><p>signals this protocol can send (<a class="reference internal" href="../pydynaa.html#pydynaa.core.EventType" title="pydynaa.core.EventType"><code class="xref py py-class docutils literal notranslate"><span class="pre">EventType</span></code></a> indexed by label).</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p>dict</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.specify_node">
<span class="sig-name descname"><span class="pre">specify_node</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.specify_node" title="Permalink to this definition"></a></dt>
<dd><p>Specify a node required by this protocol.</p>
<p>The protocol cannot start until all specified nodes are set.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.start">
<span class="sig-name descname"><span class="pre">start</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.start" title="Permalink to this definition"></a></dt>
<dd><p>Start the protocol.</p>
<p>Will register the protocol and run up to the first yield.
Will not start any sub-protocols. Sub-protocols are started in the run().
When run() is not overridden it will start all sub-protocol in parallel automatically.
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.start_subprotocols">
<span class="sig-name descname"><span class="pre">start_subprotocols</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.start_subprotocols" title="Permalink to this definition"></a></dt>
<dd><p>Start all the sub-protocols in parallel.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.stop">
<span class="sig-name descname"><span class="pre">stop</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.stop" title="Permalink to this definition"></a></dt>
<dd><p>Stop the protocol as well as any running sub-protocols.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.subprotocols">
<span class="sig-name descname"><span class="pre">subprotocols</span></span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.subprotocols" title="Permalink to this definition"></a></dt>
<dd><p>sub-protocols of this protocol.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.ConstrainedMap" title="netsquid.util.constrainedmap.ConstrainedMap"><code class="xref py py-obj docutils literal notranslate"><span class="pre">ConstrainedMap</span></code></a></p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.CorrectionProtocol.uid">
<span class="sig-name descname"><span class="pre">uid</span></span><a class="headerlink" href="#netsquid.examples.teleportation.CorrectionProtocol.uid" title="Permalink to this definition"></a></dt>
<dd><p>returns a unique identifier for this entity in the simulation.</p>
<p>Each entity has a unique identifier in the simulation.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dt class="sig sig-object py" id="netsquid.examples.teleportation.create_processor">
<span class="sig-prename descclassname"><span class="pre">netsquid.examples.teleportation.</span></span><span class="sig-name descname"><span class="pre">create_processor</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">depolar_rate</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">dephase_rate</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.create_processor" title="Permalink to this definition"></a></dt>
<dd><p>Factory to create a quantum processor for each end node.</p>
<p>Has two memory positions and the physical instructions necessary
for teleportation.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>depolar_rate</strong> (<em>float</em>) – Depolarization rate of qubits in memory.</p></li>
<li><p><strong>dephase_rate</strong> (<em>float</em>) – Dephasing rate of physical measurement instruction.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
...
<dl class="py function">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.example_network_setup">
<span class="sig-prename descclassname"><span class="pre">netsquid.examples.teleportation.</span></span><span class="sig-name descname"><span class="pre">example_network_setup</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">node_distance</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0.004</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">depolar_rate</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">10000000.0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">dephase_rate</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0.2</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.example_network_setup" title="Permalink to this definition"></a></dt>
<dd><p>Setup the physical components of the quantum network.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>node_distance</strong> (<em>float, optional</em>) – Distance between nodes.</p></li>
<li><p><strong>depolar_rate</strong> (<em>float, optional</em>) – Depolarization rate of qubits in memory.</p></li>
<li><p><strong>dephase_rate</strong> (<em>float, optional</em>) – Dephasing rate of physical measurement instruction.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>A Network with nodes “Alice” and “Bob”,
connected by an entangling connection and a classical connection</p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p><code class="xref py py-class docutils literal notranslate"><span class="pre">Network</span></code></p>
</dd>
</dl>
</dd></dl>

<dl class="py function">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.example_sim_setup">
<span class="sig-prename descclassname"><span class="pre">netsquid.examples.teleportation.</span></span><span class="sig-name descname"><span class="pre">example_sim_setup</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">node_A</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">node_B</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.example_sim_setup" title="Permalink to this definition"></a></dt>
<dd><p>Example simulation setup with data collector for teleportation protocol.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>node_A</strong> (<a class="reference internal" href="../api_nodes/netsquid.nodes.node.html#netsquid.nodes.node.Node" title="netsquid.nodes.node.Node"><code class="xref py py-class docutils literal notranslate"><span class="pre">Node</span></code></a>) – Node corresponding to Alice.</p></li>
<li><p><strong>node_B</strong> (<a class="reference internal" href="../api_nodes/netsquid.nodes.node.html#netsquid.nodes.node.Node" title="netsquid.nodes.node.Node"><code class="xref py py-class docutils literal notranslate"><span class="pre">Node</span></code></a>) – Node corresponding to Bob.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p><ul class="simple">
<li><p><a class="reference internal" href="../api_protocols/netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a> – Alice’s protocol.</p></li>
<li><p><a class="reference internal" href="../api_protocols/netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a> – Bob’s protocol.</p></li>
<li><p><a class="reference internal" href="../api_util/netsquid.util.datacollector.html#netsquid.util.datacollector.DataCollector" title="netsquid.util.datacollector.DataCollector"><code class="xref py py-class docutils literal notranslate"><span class="pre">DataCollector</span></code></a> – Data collector to record fidelity.</p></li>
</ul>
</p>
</dd>
</dl>
...
<dl class="py function">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.run_experiment">
<span class="sig-prename descclassname"><span class="pre">netsquid.examples.teleportation.</span></span><span class="sig-name descname"><span class="pre">run_experiment</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">num_runs</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">depolar_rates</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">distance</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0.004</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">dephase_rate</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0.0</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.run_experiment" title="Permalink to this definition"></a></dt>
<dd><p>Setup and run the simulation experiment.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>num_runs</strong> (<em>int</em>) – Number of cycles to run teleportation for.</p></li>
<li><p><strong>depolar_rates</strong> (<em>list of float</em>) – List of depolarization rates to repeat experiment for.</p></li>
<li><p><strong>distance</strong> (<em>float, optional</em>) – Distance between nodes [km].</p></li>
<li><p><strong>dephase_rate</strong> (<em>float, optional</em>) – Dephasing rate of physical measurement instruction.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
...
<dl class="py function">
<dt class="sig sig-object py" id="netsquid.examples.teleportation.create_plot">
<span class="sig-prename descclassname"><span class="pre">netsquid.examples.teleportation.</span></span><span class="sig-name descname"><span class="pre">create_plot</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.teleportation.create_plot" title="Permalink to this definition"></a></dt>
<dd><p>Show a plot of fidelity verus depolarization rate.</p>
</dd></dl>
        ...
        <a href="../netsquid.examples.html" class="btn btn-neutral float-left" title="netsquid.examples" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.examples.entanglenodes.html" class="btn btn-neutral float-right" title="netsquid.examples.entanglenodes" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
