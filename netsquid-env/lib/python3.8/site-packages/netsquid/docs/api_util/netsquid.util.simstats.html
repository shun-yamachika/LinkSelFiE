...
<head>
  ...
  <title>netsquid.util.simstats &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.util.datacollector" href="netsquid.util.datacollector.html" />
    <link rel="prev" title="netsquid.util.simlog" href="netsquid.util.simlog.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.util.simstats</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.util.simstats</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_util/netsquid.util.simstats.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.util.simlog.html" class="btn btn-neutral float-left" title="netsquid.util.simlog" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.util.datacollector.html" class="btn btn-neutral float-right" title="netsquid.util.datacollector" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.util.simstats">
<span id="netsquid-util-simstats"></span><h1>netsquid.util.simstats<a class="headerlink" href="#module-netsquid.util.simstats" title="Permalink to this heading"></a></h1>
<p>Defines a class for collecting simulation statistics.</p>
...
<span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">netsquid.util.simstats</span> <span class="kn">import</span> <span class="o">*</span>
</pre></div>
</div>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.util.simstats.SimStats">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.util.simstats.</span></span><span class="sig-name descname"><span class="pre">SimStats</span></span><a class="headerlink" href="#netsquid.util.simstats.SimStats" title="Permalink to this definition"></a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
<p>Collector of simulation statistics.</p>
<p>Will collect statistics such as wall-time and simulation-time,
quantum operations, triggered events and called handlers, etc.</p>
<p class="rubric">Examples</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">stats</span> <span class="o">=</span> <span class="n">SimStats</span><span class="p">()</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">stats</span><span class="o">.</span><span class="n">start</span><span class="p">()</span>
...
<span class="gp">&gt;&gt;&gt; </span><span class="n">stats</span><span class="o">.</span><span class="n">end</span><span class="p">()</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">stats</span><span class="o">.</span><span class="n">data</span><span class="p">[</span><span class="s2">&quot;quantum_ops_total&quot;</span><span class="p">])</span>
<span class="go">1</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">stats</span><span class="o">.</span><span class="n">summary</span><span class="p">())</span>
<span class="gp">...</span>
</pre></div>
</div>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.util.simstats.SimStats.start">
<span class="sig-name descname"><span class="pre">start</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.simstats.SimStats.start" title="Permalink to this definition"></a></dt>
<dd><p>Start the collection of simulation statistics.</p>
<p>Resets any previous data collection.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.util.simstats.SimStats.end">
<span class="sig-name descname"><span class="pre">end</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.simstats.SimStats.end" title="Permalink to this definition"></a></dt>
<dd><p>Finalise the collection of simulation statistics.</p>
</dd></dl>

<dl class="py property">
<dt class="sig sig-object py" id="netsquid.util.simstats.SimStats.ended">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">ended</span></span><a class="headerlink" href="#netsquid.util.simstats.SimStats.ended" title="Permalink to this definition"></a></dt>
<dd><p>whether collection has ended.</p>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.util.simstats.SimStats.data">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">data</span></span><a class="headerlink" href="#netsquid.util.simstats.SimStats.data" title="Permalink to this definition"></a></dt>
<dd><p>accumulated simulation statistics.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.util.simstats.SimStats.summary">
<span class="sig-name descname"><span class="pre">summary</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.simstats.SimStats.summary" title="Permalink to this definition"></a></dt>
<dd><p>str: a printable summary of the accumulated data.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.util.simstats.SimStats.timeline_status">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">timeline_status</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.simstats.SimStats.timeline_status" title="Permalink to this definition"></a></dt>
<dd><p>str: status of simulation timeline.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.util.simstats.SimStats.record">
<span class="sig-name descname"><span class="pre">record</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.simstats.SimStats.record" title="Permalink to this definition"></a></dt>
<dd><p>Context manager for recording simulation statistics.</p>
<p>Starts and ends this object.</p>
<p>Used by the <a class="reference internal" href="netsquid.util.simtools.html#netsquid.util.simtools.sim_run" title="netsquid.util.simtools.sim_run"><code class="xref py py-func docutils literal notranslate"><span class="pre">sim_run()</span></code></a> function
to record simulation run statistics.</p>
<p class="rubric">Example</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">stats</span> <span class="o">=</span> <span class="n">SimStats</span><span class="p">()</span>
<span class="gp">&gt;&gt;&gt; </span><span class="k">with</span> <span class="n">stats</span><span class="o">.</span><span class="n">record</span><span class="p">():</span>
<span class="gp">... </span>    <span class="n">q1</span><span class="p">,</span> <span class="n">q2</span> <span class="o">=</span> <span class="n">ns</span><span class="o">.</span><span class="n">qubits</span><span class="o">.</span><span class="n">create_qubits</span><span class="p">(</span><span class="mi">2</span><span class="p">)</span>
<span class="gp">... </span>    <span class="n">ns</span><span class="o">.</span><span class="n">qubits</span><span class="o">.</span><span class="n">operate</span><span class="p">([</span><span class="n">q1</span><span class="p">,</span> <span class="n">q2</span><span class="p">],</span> <span class="n">ns</span><span class="o">.</span><span class="n">CNOT</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="k">assert</span><span class="p">(</span><span class="n">stats</span><span class="o">.</span><span class="n">ended</span><span class="p">)</span>
...
<span class="gp">...</span>
        ...
        <a href="netsquid.util.simlog.html" class="btn btn-neutral float-left" title="netsquid.util.simlog" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.util.datacollector.html" class="btn btn-neutral float-right" title="netsquid.util.datacollector" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
