...
<span id="netsquid-util-simlog"></span><h1>netsquid.util.simlog<a class="headerlink" href="#module-netsquid.util.simlog" title="Permalink to this heading"></a></h1>
...
<span class="sig-prename descclassname"><span class="pre">netsquid.util.simlog.</span></span><span class="sig-name descname"><span class="pre">logger</span></span><em class="property"><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">&lt;Logger</span> <span class="pre">netsquid</span> <span class="pre">(WARNING)&gt;</span></em><a class="headerlink" href="#netsquid.util.simlog.logger" title="Permalink to this definition"></a></dt>
...
<span class="sig-prename descclassname"><span class="pre">netsquid.util.simlog.</span></span><span class="sig-name descname"><span class="pre">get_loggers</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.simlog.get_loggers" title="Permalink to this definition"></a></dt>
...
<dl class="py function">
<dt class="sig sig-object py" id="netsquid.util.simlog.warn_time_accuracy_issues">
<span class="sig-prename descclassname"><span class="pre">netsquid.util.simlog.</span></span><span class="sig-name descname"><span class="pre">warn_time_accuracy_issues</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">message</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">key</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">'time_accuracy_warn'</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">stacklevel</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">1</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.simlog.warn_time_accuracy_issues" title="Permalink to this definition"></a></dt>
<dd><p>Warn that the simulation time manipulation may incur numeric inaccuracies.</p>
<dl class="field-list simple">
...
<span class="sig-prename descclassname"><span class="pre">netsquid.util.simlog.</span></span><span class="sig-name descname"><span class="pre">warn_deprecated</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">message</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">key</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">stacklevel</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">2</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.simlog.warn_deprecated" title="Permalink to this definition"></a></dt>
