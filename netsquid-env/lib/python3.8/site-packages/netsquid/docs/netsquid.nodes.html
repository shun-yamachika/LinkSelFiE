...
<head>
  ...
  <title>netsquid.nodes &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.nodes.node" href="api_nodes/netsquid.nodes.node.html" />
    <link rel="prev" title="netsquid.components.models.cerrormodels" href="api_models/netsquid.components.models.cerrormodels.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">netsquid.nodes</a><ul>
...
<li class="toctree-l1"><a class="reference internal" href="CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.nodes</li>
      <li class="wy-breadcrumbs-aside">
            <a href="_sources/netsquid.nodes.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="api_models/netsquid.components.models.cerrormodels.html" class="btn btn-neutral float-left" title="netsquid.components.models.cerrormodels" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="api_nodes/netsquid.nodes.node.html" class="btn btn-neutral float-right" title="netsquid.nodes.node" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="netsquid-nodes">
<h1>netsquid.nodes<a class="headerlink" href="#netsquid-nodes" title="Permalink to this heading"></a></h1>
<p><em>Nodes</em> are composite components that represent the location entities (<a class="reference internal" href="pydynaa.html#pydynaa.core.Entity" title="pydynaa.core.Entity"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Entity</span></code></a>) of a quantum network. At these locations classical and quantum operations are considered local.
<em>Connections</em> are composite components that link remote nodes.</p>
<div class="toctree-wrapper compound">
<p class="caption" role="heading"><span class="caption-text">Modules</span></p>
<ul>
<li class="toctree-l1"><a class="reference internal" href="api_nodes/netsquid.nodes.node.html">netsquid.nodes.node</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_nodes/netsquid.nodes.node.html#netsquid.nodes.node.Node"><code class="docutils literal notranslate"><span class="pre">Node</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_nodes/netsquid.nodes.connections.html">netsquid.nodes.connections</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_nodes/netsquid.nodes.connections.html#netsquid.nodes.connections.Connection"><code class="docutils literal notranslate"><span class="pre">Connection</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_nodes/netsquid.nodes.connections.html#netsquid.nodes.connections.DirectConnection"><code class="docutils literal notranslate"><span class="pre">DirectConnection</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_nodes/netsquid.nodes.network.html">netsquid.nodes.network</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_nodes/netsquid.nodes.network.html#netsquid.nodes.network.Network"><code class="docutils literal notranslate"><span class="pre">Network</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_nodes/netsquid.nodes.network.html#netsquid.nodes.network.NetworkError"><code class="docutils literal notranslate"><span class="pre">NetworkError</span></code></a></li>
</ul>
</li>
</ul>
</div>
        ...
        <a href="api_models/netsquid.components.models.cerrormodels.html" class="btn btn-neutral float-left" title="netsquid.components.models.cerrormodels" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="api_nodes/netsquid.nodes.node.html" class="btn btn-neutral float-right" title="netsquid.nodes.node" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
