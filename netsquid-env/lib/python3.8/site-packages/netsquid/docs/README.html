...
<h1>NetSquid: the Network Simulator for Quantum Information using Discrete events<a class="headerlink" href="#netsquid-the-network-simulator-for-quantum-information-using-discrete-events" title="Permalink to this heading"></a></h1>
<blockquote>
<div><p><strong><em>NOTE:</em> (19.12.2023)</strong> The management of NetSquid will be transfered from TNO to the Technical University of Delft (TUD). This means that the NetSquid source code repository will be migrated to a TUD managed server, hosted through <a class="reference external" href="https://github.com/QuTech-Delft/NetSquid">GitHub</a>. Eventually, the TUD will publish NetSquid under an Open Source lisence.</p>
<p>This repository (on GitLab) will be <strong>archived</strong> (which makes it read-only) and further development here will be ceased as soon as the GitHub hosted repository by the TUD is made public.</p>
</div></blockquote>
<hr class="docutils" />
