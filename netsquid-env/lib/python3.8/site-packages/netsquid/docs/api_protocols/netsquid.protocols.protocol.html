...
<head>
  ...
  <title>netsquid.protocols.protocol &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.protocols.nodeprotocols" href="netsquid.protocols.nodeprotocols.html" />
    <link rel="prev" title="netsquid.protocols" href="../netsquid.protocols.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.protocols.protocol</a></li>
...
<li class="toctree-l3"><a class="reference internal" href="netsquid.protocols.serviceprotocol.html">netsquid.protocols.serviceprotocol</a></li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.protocols.protocol</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_protocols/netsquid.protocols.protocol.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="../netsquid.protocols.html" class="btn btn-neutral float-left" title="netsquid.protocols" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.protocols.nodeprotocols.html" class="btn btn-neutral float-right" title="netsquid.protocols.nodeprotocols" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.protocols.protocol">
<span id="netsquid-protocols-protocol"></span><h1>netsquid.protocols.protocol<a class="headerlink" href="#module-netsquid.protocols.protocol" title="Permalink to this heading"></a></h1>
<p>Defines the protocol base class, a virtual entity used to describe the behaviour of a quantum network.</p>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.protocols.protocol.</span></span><span class="sig-name descname"><span class="pre">Protocol</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol" title="Permalink to this definition"></a></dt>
...
<p>Abstract base class for a general quantum network protocol.</p>
<p>Protocols are intended to manipulate physical network components.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>name</strong> (<em>str or None, optional</em>) – Name of protocol. If None, the name of the class is used.</p>
</dd>
</dl>
<p class="rubric">Notes</p>
<p>Good practice is to keep protocols running on one node, see e.g.
<a class="reference internal" href="netsquid.protocols.nodeprotocols.html#netsquid.protocols.nodeprotocols.NodeProtocol" title="netsquid.protocols.nodeprotocols.NodeProtocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">NodeProtocol</span></code></a>.
A Protocol that runs on multiple nodes can for instance start sub-protocols that run on one node.</p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.add_signal">
<span class="sig-name descname"><span class="pre">add_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">event_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.add_signal" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.add_subprotocol">
<span class="sig-name descname"><span class="pre">add_subprotocol</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">subprotocol</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.add_subprotocol" title="Permalink to this definition"></a></dt>
<dd><p>Add a sub-protocol to this protocol.</p>
<p>Neither protocol should be running and both protocols must be able to
signal to each other (see <a class="reference internal" href="#netsquid.protocols.protocol.Protocol.can_signal_to" title="netsquid.protocols.protocol.Protocol.can_signal_to"><code class="xref py py-meth docutils literal notranslate"><span class="pre">can_signal_to()</span></code></a>).</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>subprotocol</strong> (<a class="reference internal" href="#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a>) – Protocol to add as a sub-protocol.</p></li>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.await_mempos_busy_toggle">
<span class="sig-name descname"><span class="pre">await_mempos_busy_toggle</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">QuantumMemory</span> <span class="pre">qmemory</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">list</span> <span class="pre">positions</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.await_mempos_busy_toggle" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.await_mempos_in_use_toggle">
<span class="sig-name descname"><span class="pre">await_mempos_in_use_toggle</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">QuantumMemory</span> <span class="pre">qmemory</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">list</span> <span class="pre">positions</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.await_mempos_in_use_toggle" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.await_port_input">
<span class="sig-name descname"><span class="pre">await_port_input</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">port</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.await_port_input" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.await_port_output">
<span class="sig-name descname"><span class="pre">await_port_output</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">port</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.await_port_output" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.await_program">
<span class="sig-name descname"><span class="pre">await_program</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">processor</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">await_done=True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">await_fail=False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.await_program" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.await_signal">
<span class="sig-name descname"><span class="pre">await_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">Protocol</span> <span class="pre">sender</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">signal_label=Signals.FINISHED</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.await_signal" title="Permalink to this definition"></a></dt>
...
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>sender</strong> (<a class="reference internal" href="#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a>) – Protocol that will send the signal.</p></li>
...
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>EventExpression that the protocol yields on.
The signal result can be retrieved from the protocol with <a class="reference internal" href="#netsquid.protocols.protocol.Protocol.get_signal_result" title="netsquid.protocols.protocol.Protocol.get_signal_result"><code class="xref py py-func docutils literal notranslate"><span class="pre">get_signal_result()</span></code></a>
or with <a class="reference internal" href="#netsquid.protocols.protocol.Protocol.get_signal_by_event" title="netsquid.protocols.protocol.Protocol.get_signal_by_event"><code class="xref py py-func docutils literal notranslate"><span class="pre">get_signal_by_event()</span></code></a></p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../pydynaa.html#pydynaa.core.EventExpression" title="pydynaa.core.EventExpression"><code class="xref py py-class docutils literal notranslate"><span class="pre">EventExpression</span></code></a></p>
</dd>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.await_timer">
<span class="sig-name descname"><span class="pre">await_timer</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">duration=0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">end_time=0</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.await_timer" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.can_signal_to">
<span class="sig-name descname"><span class="pre">can_signal_to</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">protocol</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.can_signal_to" title="Permalink to this definition"></a></dt>
<dd><p>Whether this protocol can send a signal to another protocol.</p>
<p>By default all base <a class="reference internal" href="#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a> can signal to each other.
Can be overridden by protocols to enforce locality.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>protocol</strong> (<a class="reference internal" href="#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a>) – Protocol to send a signal to.</p>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.check_assigned">
<em class="property"><span class="pre">static</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">check_assigned</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">inputs</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">input_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.check_assigned" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.get_signal_by_event">
<span class="sig-name descname"><span class="pre">get_signal_by_event</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">event</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">receiver</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.get_signal_by_event" title="Permalink to this definition"></a></dt>
...
<li><p><strong>receiver</strong> (<a class="reference internal" href="#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a> or None, optional) – The protocol wanting to receive the signal value. If not None,
will check if signalling is possible using
<a class="reference internal" href="#netsquid.protocols.protocol.Protocol.can_signal_to" title="netsquid.protocols.protocol.Protocol.can_signal_to"><code class="xref py py-meth docutils literal notranslate"><span class="pre">can_signal_to()</span></code></a></p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
...
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="#netsquid.protocols.protocol.SignalResult" title="netsquid.protocols.protocol.SignalResult"><code class="xref py py-obj docutils literal notranslate"><span class="pre">SignalResult</span></code></a> or None</p>
</dd>
</dl>
<p class="rubric">Notes</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.get_signal_result">
<span class="sig-name descname"><span class="pre">get_signal_result</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">receiver</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.get_signal_result" title="Permalink to this definition"></a></dt>
<dd><p>Get the result of the last signal sent with this label.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>label</strong> (<code class="xref py py-obj docutils literal notranslate"><span class="pre">str</span></code> or <code class="xref py py-obj docutils literal notranslate"><span class="pre">int</span></code> or <a class="reference internal" href="#netsquid.protocols.protocol.Signals" title="netsquid.protocols.protocol.Signals"><code class="xref py py-class docutils literal notranslate"><span class="pre">Signals</span></code></a>) – Label that the signal was broadcasted with.</p></li>
<li><p><strong>receiver</strong> (<a class="reference internal" href="#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a> or None, optional) – The protocol wanting to receive the signal value. If not None,
...
<li><p><strong>KeyError</strong> – When the signal label is unknown i.e. hasn’t been added yet with
    <a class="reference internal" href="#netsquid.protocols.protocol.Protocol.add_signal" title="netsquid.protocols.protocol.Protocol.add_signal"><code class="xref py py-meth docutils literal notranslate"><span class="pre">add_signal()</span></code></a>.</p></li>
</ul>
</dd>
</dl>
</dd></dl>
...
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.is_connected">
<span class="sig-name descname"><span class="pre">is_connected</span></span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.is_connected" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.is_running">
<span class="sig-name descname"><span class="pre">is_running</span></span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.is_running" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.name" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.remove">
<span class="sig-name descname"><span class="pre">remove</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.remove" title="Permalink to this definition"></a></dt>
<dd><p>Removes the entity from the simulation.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.reset" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.run">
<span class="sig-name descname"><span class="pre">run</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.run" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.send_signal">
<span class="sig-name descname"><span class="pre">send_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">signal_label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">result</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.send_signal" title="Permalink to this definition"></a></dt>
<dd><p>Send a signal to other protocols to indicate a status change or announce a result.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>signal_label</strong> (<code class="xref py py-obj docutils literal notranslate"><span class="pre">str</span></code> or <code class="xref py py-obj docutils literal notranslate"><span class="pre">int</span></code> or <a class="reference internal" href="#netsquid.protocols.protocol.Signals" title="netsquid.protocols.protocol.Signals"><code class="xref py py-class docutils literal notranslate"><span class="pre">Signals</span></code></a>) – Label, key or status that is broadcasted to the world. Other protocols can wait for this signal.</p></li>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.signals">
<span class="sig-name descname"><span class="pre">signals</span></span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.signals" title="Permalink to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.start">
<span class="sig-name descname"><span class="pre">start</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.start" title="Permalink to this definition"></a></dt>
...
<dt class="field-even">Return type<span class="colon">:</span></dt>
<dd class="field-even"><p><a class="reference internal" href="#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a></p>
</dd>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.start_subprotocols">
<span class="sig-name descname"><span class="pre">start_subprotocols</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.start_subprotocols" title="Permalink to this definition"></a></dt>
<dd><p>Start all the sub-protocols in parallel.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.stop">
<span class="sig-name descname"><span class="pre">stop</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.stop" title="Permalink to this definition"></a></dt>
<dd><p>Stop the protocol as well as any running sub-protocols.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.subprotocols">
<span class="sig-name descname"><span class="pre">subprotocols</span></span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.subprotocols" title="Permalink to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Protocol.uid">
<span class="sig-name descname"><span class="pre">uid</span></span><a class="headerlink" href="#netsquid.protocols.protocol.Protocol.uid" title="Permalink to this definition"></a></dt>
...
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.Signals">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.protocols.protocol.</span></span><span class="sig-name descname"><span class="pre">Signals</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">value</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.Signals" title="Permalink to this definition"></a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">Enum</span></code></p>
<p>A collection of default signal types that protocols can use.</p>
</dd></dl>

<dl class="py class">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.SignalResult">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.protocols.protocol.</span></span><span class="sig-name descname"><span class="pre">SignalResult</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">result</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.SignalResult" title="Permalink to this definition"></a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">tuple</span></code></p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.SignalResult.count">
<span class="sig-name descname"><span class="pre">count</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">value</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">/</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.SignalResult.count" title="Permalink to this definition"></a></dt>
<dd><p>Return number of occurrences of value.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.SignalResult.index">
<span class="sig-name descname"><span class="pre">index</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">value</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">start</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">stop</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">9223372036854775807</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">/</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.protocol.SignalResult.index" title="Permalink to this definition"></a></dt>
<dd><p>Return first index of value.</p>
<p>Raises ValueError if the value is not present.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.SignalResult.label">
<span class="sig-name descname"><span class="pre">label</span></span><a class="headerlink" href="#netsquid.protocols.protocol.SignalResult.label" title="Permalink to this definition"></a></dt>
<dd><p>Alias for field number 0</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.protocols.protocol.SignalResult.result">
<span class="sig-name descname"><span class="pre">result</span></span><a class="headerlink" href="#netsquid.protocols.protocol.SignalResult.result" title="Permalink to this definition"></a></dt>
<dd><p>Alias for field number 1</p>
        ...
        <a href="../netsquid.protocols.html" class="btn btn-neutral float-left" title="netsquid.protocols" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.protocols.nodeprotocols.html" class="btn btn-neutral float-right" title="netsquid.protocols.nodeprotocols" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
