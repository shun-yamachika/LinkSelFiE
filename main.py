...
#    algorithm_names = ["Vanilla NB","LinkSelFiE","Succ. Elim. NB",]
    ...
    path_num_list2 = [2, 4, 6, 8, 10, 12, 14]  # For error vs path num    
    ...
    for noise_model in noise_model_names:
        ...
        results.append(p.apply_async(plot_accuracy_vs_path_num, args=(path_num_list2, algorithm_names, noise_model, 20)))
